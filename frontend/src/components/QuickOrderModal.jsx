...
import { useCreateSalesOrder, useUpdateExtraCharge, useOverrideLineTax } from "../hooks/useSales";
      ...
      <div className="relative w-full max-w-[90vw] lg:max-w-[40vw] bg-white rounded-lg border border-gray-200 shadow-xl flex flex-col max-h-full">
              ...
              {!isCreatingClient ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full py-2 border border-dashed border-gray-300 rounded text-sm text-gray-600 hover:bg-gray-50 hover:text-primary-600"
                  >
                ...
                <div className="p-4 bg-gray-50 border border-gray-200 rounded space-y-3">
                  ...
                  <div className="flex gap-2 justify-end mt-2">
                    ...
                    <button
                      ...
                      className="text-xs px-3 py-1.5 rounded bg-primary-600 text-white hover:opacity-95 disabled:opacity-50"
                    >
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <button
                  type="button"
                  onClick={addLine}
                  className="text-xs px-3 py-1.5 rounded bg-primary-50 text-primary-600 font-medium hover:bg-primary-100"
                >
                  + Add Item Line
                </button>
              </div>
              ...
              {!isCreatingItem ? (
                <button
                  ...
                  className="w-full py-2 mt-2 border border-dashed border-gray-300 rounded text-sm text-gray-600 hover:bg-gray-50 hover:text-primary-600"
                >
              ...
              <div className="bg-gray-50 border border-gray-200 rounded p-4 text-sm">
                ...
                <div className="border-t border-gray-200 pt-4 space-y-2">
                  ...
                  <div className="flex justify-between font-semibold text-base pt-2 border-t border-gray-200">
                    ...
                    <span className="text-primary-700">{money(totals.subtotal + totals.tax)}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="px-5 py-4 border-t border-gray-200 flex items-center justify-between shrink-0 bg-gray-50 rounded-b-lg">
          ...
          {step < 3 ? (
            <button
              type="button"
              className="text-sm px-4 py-2 bg-primary-600 text-white rounded shadow-sm hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed"
              onClick={() => setStep((s) => s + 1)}
              disabled={
                (step === 1 && !client?.id) || 
